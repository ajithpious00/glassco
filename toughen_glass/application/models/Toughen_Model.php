<?php
class Toughen_Model extends CI_Model
{
	...
	public function get_work_order($tablearr)
	{
		...
		if ($q->result()) {
			foreach ($q->result() as $row) {
				$slno++;
				$status = array("1" => "Order Taken", "2" => "Accepted", "3" => "Approved", "4" => "Rejected", "10" => "washing Completed");
				...
				$details = '<a href="toughen/detailview/' . $row->CU_Id . '"><i class="fa fa fa-eye"></i></a>';
				$data[] = array(
