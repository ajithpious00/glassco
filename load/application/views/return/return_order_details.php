					...
					<div class="card-body">
						<div class="row maintitle">
							<div class="col-md-6 col-sm-6 text-left">
								<img src="<?php echo base_url(); ?>assets/images/logo/imgpsh_fullsize_anim.jpg" width="300" height="100" alt="logo" />
							</div>
								...
								<address class="color-font">
									...
									<ul class="list-unstyled">
										<li class="color-font"><strong>User Name :&nbsp;&nbsp;</strong>
											<?php echo ucfirst($customerdetail->US_Name); ?>
										</li>
						...
						<div class="box-body">
							...
							<div class="color-font">
								<center> <strong>RETURN ORDER INFORMATION
										<hr>
									</strong>
							</div>
							...
							<div class="row">
								<div class="col-sm-6 color-font text-left">
									<ul class="list-unstyled">
										...
										<li>
											<textarea class="form-control" name="" id="" cols="30" rows="10" disabled><?php echo $reason;?></textarea>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="panel panel-default text-right">
							<div class="panel-body">
								...
								?>
								<div>
									<a class="btn btn-primary" href="<?php echo base_url() . 'history'; ?>"><i class="fa fa-reply"></i> Back</a>
