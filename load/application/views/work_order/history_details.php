					...
					<div class="card-body">
						<div class="row maintitle">
							<div class="col-md-6 col-sm-6 text-left">
								<a class="navbar-brand brand-logo" href="<?php echo base_url(); ?>sales_enquiries"><img
						...
						<div class="box-body">
							...
							<div class="color-font">
								<center> <strong>COMPLETED ORDER INFORMATION
										<hr>
									</strong>
							</div>
						...
						<div class="panel panel-default text-right">
							<div class="panel-body">
								...
								?>
								<div>
									<a class="btn btn-primary" href="<?php echo base_url() . 'history'; ?>"><i
