    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="position-fixed nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url(); ?>loading">
                        <span class="icon-bg"><i class="mdi mdi-truck-fast"></i></span>
                        <span class="menu-title">Out for Delivery</span>
                    </a>
                </li>
                <!-- <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url(); ?>returning">
                        <span class="icon-bg"><i class="mdi mdi-redo-variant"></i></span>
