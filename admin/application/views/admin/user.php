                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" name="userForm" id="userForm" action="<?php echo base_url();?>admin/user/insert" method="post">
                     ...
                     <div class="form-group" id="saleArea" style='display:none;'>
					   ...
					   <div class="form-group">
                        <label for="PerfomaInvoceCode">Perfoma Invoice Code</label>
                        <input type="text" class="form-control" id="perfomainvoice" name="perfomainvoice" placeholder="Enter the Perfoma Invoice Code">
                      </div>
					   <div class="form-group">
                        <label for="InvoiceCode">Invoice Code</label>
                        <input type="text" class="form-control" id="invoice" name="invoice" placeholder="Enter the Invoice Code">
                      </div>
                      <button type="button" class="btn btn-primary mr-2" name="saveUser" id="saveUser">Save</button>
                      <a href="<?php echo base_url(); ?>admin/Viewuser"><button type="button" class="btn btn-light" name="cancelUser" id="cancelUser">Cancel</button></a>
