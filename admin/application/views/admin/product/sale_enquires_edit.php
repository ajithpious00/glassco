							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="gst" name="gst"
										value="<?php echo $customerdetail->CU_Gst_No; ?>">
								</div>
										...
										<tr>
											...
											<td>
												<div class="form-group">
													...
													<input type="text" class="form-control" id="width1[]"
														name="width1[]"
														onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
														placeholder="width">
												</div>
											...
											<td>
												<div class="form-group">
													...
													<input type="text" class="form-control" id="wastage1[]"
														name="wastage1[]"
														onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
														placeholder="Wastage">
												</div>
												...
												<td>
													<div class="form-group">
														<input type="text" class="form-control" id="wastage[]"
															name="wastage[]"
															onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
															placeholder="Wastage" value="<?php echo $vd->PD_Waste; ?>">
													</div>
												</td>
												<td>
													<div class="form-group">
												...
												<td>
													<div class="form-group">
														...
														<input type="text" class="form-control" id="pid[]" name="pid[]"
															hidden placeholder="Rate" value="<?php echo $vd->SP_Id; ?>">
													</div>
												</td>
												</td>
												<td>
													<div class="form-group">
														<button onclick="removerow(<?php echo $vd->SP_Id; ?>)" name="remove"
															<?php echo $vd->SP_Id; ?>"'<?php echo $id ?>'"
												...
												<td>
													<div class="form-group">
														<input type="text" class="form-control" id="quan[]" name="quan[]"
															onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
															placeholder="Quantity" value="<?php echo $ai->AD_Quantity ?>">
													</div>
												</td>
												<td>
													<div class="form-group">
														<input type="text" class="form-control" id="unit_price[]"
															...
															value="<?php echo $ai->AD_Unit_Price ?>">
													</div>
												</td>
												</td>
											</tr>
