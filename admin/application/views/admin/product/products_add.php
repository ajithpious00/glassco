              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form id="productadd" name="productadd" class="form-horizontal" method="post"
					...
					<label for="brandName">Choose Brand</label>
					  ...
					  <div class="form-group">
										...
										<div class="col-sm-20">
											<select class="form-control select2" style="width: 100%;" name="status" id="status">
												...
												<option <?php if($data['Status'] == 2){ echo 'selected'; } ?> value="2">Suspend</option>
											</select>
										</div>
									</div>
					 <!-- <div class="form-group">
					 ...
					 <!-- <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="productprice" name="productprice" placeholder="Enter Unit Price">
                      </div>
					   <div class="form-group">
                        <label for="productUnitPrice">Product Weight</label>
                        <input type="text" class="form-control" id="productweight" name="productweight" placeholder="Enter Product weight (1 Sqrmetr == weight in Kg)">
                      </div>
					  <div class="form-group">
