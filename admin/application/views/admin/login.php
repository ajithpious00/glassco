          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
				...
				<a class="navbar-brand brand-logo" href="<?php echo base_url();?>admin/Login"><img src="<?php echo base_url();?>assets/admin/images/logo/imgpsh_fullsize_anim.jpg" width="500" height="100" alt="logo"/></a>
				...
				<?php 
                        ...
                        ?>
                            <div class="form-group">
                                <div class="alert alert-danger">
                                    <strong>Incorrect username or password !</strong> Error.
                                </div>
                            </div>
                        ...
                        ?>
                <form class="pt-3" name="frmlogin" id="frmlogin" method="post" action="<?php echo base_url();?>admin/Login/display">
                  <div class="form-group">
                  ...
                  <div class="mt-3">
                   <input type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" name="submit" id="submit" value="Login">
                  </div>
