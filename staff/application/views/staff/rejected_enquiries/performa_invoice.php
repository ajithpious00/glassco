				...
				<div class="card">
					<div class="card-body">
						<div class="row maintitle">
							<div class="col-md-6 col-sm-6 text-left">
								<a class="navbar-brand brand-logo"><img
									src="<?php echo base_url(); ?>assets/admin/images/logo/imgpsh_fullsize_anim.jpg" width="300" height="100"  alt="logo" />
								</a>
							</div>
						...
						<div class="box-body"id ="perfomainvoice">
							...
							<div class ="color-font"><center> <strong>PERFORMA INVOICE<hr></strong></div>
							<div class="table-responsive">
								<table class="display dataTable">
									<thead>
										...
										<tr>
											<th><?php echo $order_number->PD_Order_No;?><br />
											<?php 
							...
							<div class ="color-font"><center> <strong>Product Details<hr></strong></div>
							<div class="table-responsive">
								<table class="display dataTable">
									<thead>
										<tr>
							...
							<div class="row">
								<div class="col-sm-6 text-left">
									<ul class="list-unstyled">
										<li class = "color-font"><b><h5>Total Taxable Amount: &nbsp;&nbsp;</b>₹<?php echo $taxable_amounts; ?></li>
										<?php 
											foreach($additional_details as $ad) {
										?>
										<li class = "color-font"><b><?php echo $ad->AU_Item?>: &nbsp;&nbsp;</b><?php echo $ad->AD_Quantity?> &nbsp;&nbsp; X  &nbsp;&nbsp;<?php echo $ad->AD_Unit_Price?></strong></li>
										<?php
										}
										?>
						...
						<div class="panel panel-default text-right button-box">
							<div class="panel-body">
								...
								<?php
									...
									if ($status = 4) {
									?>
									<a class="btn btn-primary" href="<?php echo AD_BASE_PATH .'work_order/work_order/'.$linkName.'"'; ?>"><i class="fa fa-check"></i> Accepted</a>
									<?php
									}
									?>
