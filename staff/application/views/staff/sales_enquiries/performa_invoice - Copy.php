								...
								<div class="col-sm-6 text-left">
									...
									<li class="color-font"><b>
										...
										<li class="color-font"><b>
											...
											<?php $taxable = $total_product_rate + $total_polish_rate + $documentation + $handling + $cutting +$transportation + $total_additional_charges; 
												echo number_format((float)$taxable, 2, '.', '');
											?>
										<!--<?php
										foreach ($additional_details as $ad) {
										...
										<li class="color-font"><b>SGST@ 9% :&nbsp;&nbsp;</b>₹
											<?php //echo $sgst; 
												$sgst = ((($total_additional_charges + $add_deta) + ($total_product_rate + $total_polish_rate)) * 9)/100;
