								...
								<div class="form-group">
										...
										<tr>
											...
											<td>
												<div class="form-group">
													...
													<input type="text" class="form-control ht" id="hsn[]"
											...
											<td>
												<div class="form-group">
													...
													<input type="text" class="form-control" id="quantity[]"
														name="quantity[]"	onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"	placeholder="Quantity">
												</div>
											</td>
											<td>
											<div class="form-group">
									...
									<table class="table table-bordered" id="product_field">
										<tr>
											...
											<td>
												<div class="form-group">
													<label for="rate" class="font-color"><b>HSN Code</b></label>
													<input type="text" class="form-control" id="hsnc"
														name="hsnc"
