...
<script>
	...
	function copyThis(el) {
		...
		var url = basePath + 'customer_invoice/getPolish';
		...
		$('.r' + p).find('.polishType').on('change', function(){
			var poId = $(this).val();
			var basePath = '<?php echo AD_BASE_PATH; ?>';
			var url = basePath + 'customer_invoice/getPolishRates';
	...
	$(document).ready(function () {
		...
		$('#save').on('click', function (e) {
			var basePath = '<?php echo AD_BASE_PATH; ?>';
			var url = basePath + 'customer_invoice/edit';
	...
	function fetchcust() {
		...
		var url = basePath + 'customer_invoice/fetchcust/' + id;
