		...
		<div class="row">
			...
			<div class="col-lg-2 my-3">
				<select class="form-control" name="invoice_type" id="invoice_type" data-id="<?php echo $cus_id; ?>" onchange="updateInvoiceType(this)">
					<option value="b_to_b" selected>B TO B</option>
					<option value="b_to_c">B TO C</option>
				</select>
			</div>
													...
													<td>
														<div class="col-12 text-left">
															...
															<ul class="list-unstyled" style="list-style-type: none; padding-left: 0px;">
																...
																<li class="color-font">
																	<b>Invoice No:</b>&nbsp;&nbsp;<?php echo 'G2B-' .ucfirst($customerdetail->CU_Id).'/23/24'; ?>
																</li>
																<li class="color-font">
							...
							<div class="panel-body">
								...
								<div>
									...
									<a class="btn btn-danger"
										...
										<a class="btn btn-primary"
											href="<?php echo AD_BASE_PATH . 'customer_invoice/e_invoice/' . $linkName . '"'; ?>"><i
												class="fa fa-check"></i> Create E Inovice</a>
