      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" name="productForm" id="productForm"
              action="<?php echo base_url(); ?>admin/product/insert" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="stockAvailability" name="stockAvailability"
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="productThickness" name="productThickness"
                  placeholder="Enter the Thickness in MM">
              </div>
              <!--<div class="form-group">
            ...
            <input type="text" id="productWeightValueMM" name="productWeightValueMM" placeholder="" readonly>
              ...
              <a href="<?php echo base_url(); ?>admin/product"><button type="button" class="btn btn-light"
                  name="cancelProduct" id="cancelProduct">Cancel</button></a>
            </form>
          </div>
        </div>
      </div>
