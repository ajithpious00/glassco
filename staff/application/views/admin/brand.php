      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" name="brandForm" id="brandForm"
              action="<?php echo base_url(); ?>admin/brand/insert" method="post">
              ...
              <div class="form-group">
                ...
                <a href="<?php echo base_url(); ?>admin/brand"><button type="button" class="btn btn-light"
                    name="cancelBrand" id="cancelBrand">Cancel</button></a>
            </form>
          </div>
        </div>
      </div>
