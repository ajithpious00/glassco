      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" name="userForm" id="userForm" action="<?php echo base_url(); ?>admin/Forms/insert"
              method="post">
              <div class="form-group">
              ...
              <div class="form-group" id="saleArea" style='display:none;'>
                ...
                <input type="text" class="form-control" id="executiveSaleArea" name="executiveSaleArea"
                  placeholder="Enter the Area of Sale">
              </div>
              <!-- <div class="form-group">
              ...
              <a href="<?php echo base_url(); ?>admin/forms"><button type="button" class="btn btn-light"
                  name="cancelUser" id="cancelUser">Cancel</button></a>
            </form>
          </div>
        </div>
      </div>
