<div class="container-scroller">
  ...
  <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a class="navbar-brand brand-logo" href="<?php echo base_url(); ?>admin/Home"><img
          src="<?php echo base_url(); ?>assets/admin/images/logo/imgpsh_fullsize_anim.jpg" width="100" height="100"
          alt="logo" /></a>
          ...
          <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm"
            ...
            <div class="p-3 text-center bg-primary">
              <img class="img-avatar img-avatar48 img-avatar-thumb"
                src="<?php echo base_url(); ?>assets/admin/images/faces/user.jpg" alt="image">
            </div>
            <div class="p-2">
      ...
      <ul class="nav">
              ...
              <div>
                <div class="d-flex align-items-center">
                  <div class="sidebar-profile-img">
                    <img src="<?php echo base_url(); ?>assets/admin/images/faces/user.jpg" width="40" height="40"
                      alt="image">
                  </div>
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-subcat">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="<?php echo base_url(); ?>admin/viewsubcategory">List</a>
              </li>
        ...
        <li class="nav-item sidebar-user-actions">
          <div class="sidebar-user-menu">
            <a href="<?php echo base_url(); ?>admin/login/logout" class="nav-link"><i
