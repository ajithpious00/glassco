...
class Return_order extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('staff/Return_order_Model');
	}
	public function index()
	{
		if (!$this->session->userdata('US_Id')) {
			...
			$this->load->view('staff/return/return_order');
			$this->load->view('staff/common/footer');
			$this->load->view('staff/return/return_order_script');
		}
	}
	...
	public function detailview($cus_id)
	{
		...
		if (!$this->session->userdata('US_Id')) {
			...
			$this->load->view('staff/common/header');
			$this->load->view('staff/common/menu');
			$this->load->view('staff/return/return_order_details', $data);
			$this->load->view('staff/common/footer');
		}
	}
	public function add_return()
	{
		if (!$this->session->userdata('US_Id')) {
			...
			$this->load->view('staff/common/header');
			$this->load->view('staff/common/menu');
			$this->load->view('staff/return/add_return', $data);
			$this->load->view('staff/common/footer');
			$this->load->view('staff/return/add_script');
		}
	}
