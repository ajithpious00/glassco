              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" name="settingsForm" id="settingsForm" action="<?php echo base_url();?>admin/settings/insert" method="post">
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="stnsiteAddress" name="stnsiteAddress" placeholder="Enter Site Address">
                      </div>
					  <div class="form-group">
                      ...
                      <a href="<?php echo base_url(); ?>admin/settings"><button type="button" class="btn btn-light" name="cancelSettings" id="cancelSettings">Cancel</button></a>
                    </form>
                  </div>
                </div>
              </div>
